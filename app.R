...
library(tm)
library(shiny)
# NÃO ESTOU UTILIZANDO library(rsconnect)
library(DT)
...
#Lendo a base do Lattes
getwd()
#SUBSTITUIR O CARACTER ' PARA N??O DAR PROBLEMA NA LEITURA
...
base <<- cbind(base, fotos, regiao, formacao_pesq, area_e_subarea_pesq)
